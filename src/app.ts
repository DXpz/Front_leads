    ...
    switch (stage.id) {
      ...
      case 'propuesta': {
        ...
        await apiFetch(`${base}/propuesta`, jsonPut({
          ...
          equipos: equiposDesc,
          rubro: snapshot.territory || stageData.industria_sector_otro || stageData.industria_sector || loadedStageDataCache.reunion?.industria_sector_otro || loadedStageDataCache.reunion?.industria_sector || '',
